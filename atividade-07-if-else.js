...
// → Seu código aqui:
// let idade = lerTeclado.questionInt("Idade"); 
// if (idade > 18){
//     console.log("Adulto")
// } else if (idade < 12){
//     console.log("Criança")
...
// → Seu código aqui:
// let temperaturaAtual = lerTeclado.questionFloat("temperatura atual: ");
...
//     Nome: lerTeclado.question("Digite seu nome: "),
//     Idade: lerTeclado.questionInt("Idade: "),
//     possuiHabilitacao: lerTeclado.keyInYN("Possui habilitação? ")
// }; 
// if (motorista.Idade > 21 && motorista.possuiHabilitacao){
//     console.log("Você pode alugar o veiculo")
// } else {
...
// → Seu código aqui:
// let ehEstudante = lerTeclado.keyInYN("Voce e estudante? ");
// let ehIdoso = lerTeclado.keyInYN("Voce tem idade 60 ou mais? ");
