...
// let inteiro = lerTeclado.questionInt("Digite um numero inteiro: ")
// let soma = 0;
// for (let i = 1; i <= inteiro; i++) {
//     soma = inteiro + soma
// };
// console.log(`A soma de 1 até ${inteiro} é ${soma}`);
...
// let number = lerTeclado.questionInt("Digite um número inteiro: ")
// let soma = 1;
