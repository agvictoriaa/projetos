...
// → Seu código aqui:
// const cidade = ["Belem", "Sao Paulo", "Rio de Janeiro", "Santa catarina", "Porto Alegre"];
// for (let i = 0; i < cidade.length; i++) {
//     console.log(`Índice ${i}: ${cidade[i]}`);
//   };

// console.log(`Total de cidades armazenadas: ${cidade.length}`);
// console.log(`Primeira cidade da lista é ${cidade[0]}`);
// console.log(`Ultima cidade da lista é: ${cidade[cidade.length -1]}`);
...
// for (let i = 0; i < numeros.length; i++) {// Neste for o indice vai começar em 0, e vou pegar a variavel 
// //numeros e usar o length, pois o mesmo mostra os itens da lista, e vou utilizar o I++ como contador, ou seja
// // enquanto ele for menor que o numero da lista, ele vai rodar. 
//   soma += numeros[i]; // aqui pé usado para somar, a soma vem como um contador e vai somando.
// }
...
// console.log(`Maior temperatura: ${Math.min(...temperaturas)}`);
...
// let paresVetor = [];// Crio a lista e deixo vazia, porque vou adicionar os numeros dentro do for usando o 
// // PUSH.
// let imparesVetor = [];
// for (numero of listaNumeros) {// Crio uma variavel numero que vai passar dentro de lista numeros e vai verificar
//     // todos os numeros pares e impares.
//     if (numero % 2 === 0) {
//         paresVetor.push(numero)// depois disso, usando o push, os numeros tanto pares quanto impares, serão
// // adicionados em casa lista, tanto de numeros pares, quanto de numeros impares.
//     }
//     if (numero % 2 !== 0) {
//         imparesVetor.push(numero)
//     }
// };
// console.log(`Pares ${paresVetor.length}: ${paresVetor}`);// Aqui eu usei para mostrar a quantidade de numeros
// // pares e impares usando o length e exibir quais eram os numeros.
// console.log(`Impares ${imparesVetor.length}: ${imparesVetor}`);
...
// let vetorInvertido = [];
// for(const listaletras of vetorOriginal){
//     vetorInvertido.unshift(listaletras)
// };
